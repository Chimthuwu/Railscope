      ...
      <header className="h-14 shrink-0 border-b border-black/10 dark:border-white/5 flex items-center justify-between px-4 md:px-6 bg-[#eceee9]/85 dark:bg-[#09090B]/80 backdrop-blur-md z-40 transition-colors duration-300">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <a
              href="https://github.com/Chimthuwu/Railscope/releases/download/v2.0.1/RailScope-Android-v2.0.1.apk"
              target="_blank"
            ...
            <a
              href="https://github.com/Chimthuwu/Railscope/releases/download/v2.0.1/RailScope-Windows-Setup-v2.0.1.exe"
              target="_blank"
              rel="noopener noreferrer"
